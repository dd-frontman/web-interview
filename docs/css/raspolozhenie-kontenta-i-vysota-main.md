...
tags:
  - "css"
  - "raspolozhenie-kontenta-i-vysota-main"
...
| `dvh`   | 1% _динамической_ высоты viewport | Адаптируется к появлению/скрытию UI браузера            | Для полноэкранных секций и page-layout на мобильных               |
| `svh`   | 1% _минимальной_ высоты viewport  | Консервативная высота (обычно меньше), стабильнее       | Когда важно избежать переполнения/обрезки при появлении панелей   |
| `lvh`   | 1% _максимальной_ высоты viewport | Берет максимальную высоту viewport                      | Когда нужен максимально высокий экранный блок                     |
