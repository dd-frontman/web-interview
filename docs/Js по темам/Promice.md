...
Promise.all([p1, p2, p3])
  .then(([res1, res2, res3]) => { /* все успешно */ })
  .catch(err => { /* хотя бы один с ошибкой */ });
```
...
Promise.race([p1, p2, p3])
  .then(result => { /* кто быстрее */ })
  .catch(error => { /* если первым завершился rejected */ });
```
...
Promise.any([p1, p2, p3])
  .then(result => { /* первый успешный */ })
  .catch(errors => { /* если все упали */ });
```
