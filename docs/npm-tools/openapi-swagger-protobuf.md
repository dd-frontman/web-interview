...
| --------------------------------------- | -------------------------------------------- | ------------------------------------------------------------------------------------- | ---------------------------------------------------------------------- |
| **Swagger Codegen / OpenAPI Generator** | OpenAPI спецификация (JSON или YAML)         | SDK / клиентские библиотеки, модели данных / типы, документация, заглушки сервера     | Используют в TypeScript / JS / Java / Go / многих языках.              |
...
- На клиенте:
  ...
  - Если ответ содержит HTTP заголовки `Cache-Control`, `ETag`, `Last-Modified` — использовать их. Проксики / CDN могут кэшировать.
