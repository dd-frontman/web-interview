...
- При использовании *Setup Store* можно внутри стора объявлять `ref()` для состояния, `computed()` для производных данных, и возвращать их. 
