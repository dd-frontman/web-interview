...
class DarkCheckbox implements Checkbox { render() { console.log("Dark check"); } }
...
class UserBuilder {
  ...
  setName(name: string) { this.u.name = name; return this; }
  setAge(age: number) { this.u.age = age; return this; }
  setEmail(email: string) { this.u.email = email; return this; }
