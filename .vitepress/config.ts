...
export default defineConfig({
	...
	themeConfig: {
		...
		sidebar: [
			{
				...
				items: [
					...
					{ text: "ref vs reactive", link: "/Vue по темам/ref vs reactive" },
					{
					...
					{
						text: "Scheduler в Vue 3",
						link: "/Vue по темам/Scheduler в Vue 3",
					},
				...
				items: [
					{
						...
						link: "/Безопасность приложений 3/Безопасность приложений в интернете",
					},
					{
						text: "XSS (Cross-Site Scripting)",
						link: "/Безопасность приложений 3/XSS (Cross-Site Scripting)",
					},
					{ text: "JWT", link: "/Безопасность приложений 3/JWT" },
					{
						text: "Cookie-сессия vs JWT",
						link: "/Безопасность приложений 3/🔐 Cookie-сессия vs JWT",
					},
					{
						text: "CSP — Content Security Policy",
						link: "/Безопасность приложений 3/🔐 CSP — Content Security Policy",
					},
					{
						text: "Авторизация",
						link: "/Безопасность приложений 3/Авторизация",
					},
				],
			},
			{
		...
		] as unknown as DefaultTheme.SidebarItem[],
