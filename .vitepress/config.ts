...
export default defineConfig({
  ...
  // Если репозиторий называется "web-interview", раскомментируйте следующую строку:
  // base: '/web-interview/',
  // Если деплоите в корневой домен, оставьте base пустым или удалите эту строку
  base: '/',
      ...
      '/Vue по темам/': [
        {
          text: 'Vue по темам',
          items: [
            { text: 'Главная', link: '/Vue по темам/' },
          ]
        }
      ],
      '/React/': [
      ...
      '/🏛️Архитектура/': [
        {
          text: 'Архитектура',
          items: [
            { text: 'Главная', link: '/🏛️Архитектура/' },
          ]
        }
      ],
    },
